        ...
        public async Task<Response> Store([FromBody] StoreColaboradorDto storeColaboradorDto)
        {
            ...
            try
            {
                ...
                var storeColaborador = await this._colaboradorModule.CrearColaborador(
                    ...
                    storeColaboradorDto.TipoDocumentoId,
                    storeColaboradorDto.NacionalidadId,
                    storeColaboradorDto.DepartamentoId,
                    storeColaboradorDto.EstadoCivilId,
                    ...
                    storeColaboradorDto.UnidadId,
                    storeColaboradorDto.SucursalId,
                    storeColaboradorDto.CargoId,
                    storeColaboradorDto.ClasificacionlaboralId,
                    storeColaboradorDto.TipoContratoId,
                    storeColaboradorDto.InformacionContableId,
                    storeColaboradorDto.CentroCostoId,
                    storeColaboradorDto.FormaPagoId,
                    storeColaboradorDto.TipoCuentaId,
                    storeColaboradorDto.BancoId,
                    storeColaboradorDto.AdministracionPensionesId,
                    storeColaboradorDto.CajaSaludId,
                    storeColaboradorDto.FormacionPrincialId,
                    storeColaboradorDto.SexoId
                );
